...
#define LORA_RST 26 //14   // GPIO14 - SX1276 RST
#define LORA_IRQ 2  // GPIO26 - SX1276 IRQ (interrupt request)
/*#define LORA_SCK 14        // GPIO5 - SX1276 SCK
#define LORA_MISO 13     // GPIO19 - SX1276 MISO
#define LORA_MOSI 12    // GPIO27 - SX1276 MOSI
#define LORA_CS 15     // GPIO18 - SX1276 CS
#define LORA_RST 32 //14   // GPIO14 - SX1276 RST
#define LORA_IRQ 23  // GPIO26 - SX1276 IRQ (interrupt request)*/
...
const int blueLED = 25;//LED_BUILTIN; 
...
void setup() {
  ...
  if (!LoRa.begin(866E6)) {
    ...
    Display.clearBuffer();  
    Display.setCursor(2,12); Display.print("LoRa Failed");
    Display.sendBuffer();
    delay(500);
    while (1);
  }
